...
| AI Assessment | **AI-оценка** | `DetectAIAuthorshipUseCase` | Вероятность, достаточность данных, top signals + дисклеймер (не «качество», а вероятностная оценка). |
...
3. Названия карточек в UI короткие и русские: «Линт», «Типы», «Сложность», «Поддержка», «Мёртвый код», «Тесты», «Дубли», «AI-оценка».
